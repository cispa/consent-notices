...
class InputManager(object):
    ...
    def __init__(self, device, app, policy_name, random_input,
                 ...
                 replay_output=None, listen_port=None, consent_group=None, consent_navigation=None):
        """
    ...
    def get_input_policy(self, device, app, master):
        if self.policy_name == POLICY_NONE:
            ...
            input_policy = MITMPolicy(device, app, self.random_input, self.policy_name, self.listen_port, self.consent_group, self.consent_navigation)
        else:
