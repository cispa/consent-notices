...
def parse_args():
    ...
    parser.add_argument("-consent_group", action="store", dest="consent_group",required=True,
                        help="name of consent group")
    parser.add_argument("-consent_navigation", action="store", dest="consent_navigation",required=True,
                        help="consent navigation name")
...
def main():
    ...
    if start_mode == "master":
        ...
        droidbot = DroidBot(
            ...
            ignore_ad=opts.ignore_ad,
            replay_output=opts.replay_output,
            consent_group=opts.consent_group,
            consent_navigation=opts.consent_navigation)
        droidbot.start()
    return
