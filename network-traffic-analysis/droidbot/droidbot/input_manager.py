...
from .input_policy import UtgBasedInputPolicy, UtgNaiveSearchPolicy, UtgGreedySearchPolicy, \
                         ...
                         POLICY_MANUAL, POLICY_MONKEY, POLICY_NONE, POLICY_MITM
...
class InputManager(object):
    ...
    def __init__(self, device, app, policy_name, random_input,
                 ...
                 replay_output=None, consent_condition=None, privacy_wording_file=None):
        """
    ...
    def get_input_policy(self, device, app, master):
        ...
        elif self.policy_name == POLICY_MITM:
            input_policy = MITMPolicy(device, app, self.random_input, self.policy_name, self.consent_condition, self.privacy_wording_file)
        else:
