...
class DroidBot(object):
	...
	def __init__(self,
				 ...
				 ignore_ad=False,
				 replay_output=None,
				 consent_condition=None,
				 privacy_wording_file=None):
		"""
	...
	def stop(self):
		self.enabled = False
		self.tear_down(self.device.listen_port)
		try:
			self.device.copy_shared_prefs(self.app.package_name, self.output_dir)
		except Exception as e:
			pass
