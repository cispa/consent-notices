...
def parse_args():    
    ...
    parser.add_argument("-p", action="store", dest="listen_port", required=False,
                        help="The port of proxy server that the device is connected")
    ...
    parser.add_argument("-consent_condition", action="store", dest="consent_condition", required=True, help="name of consent condition: confirm or reject")    
    parser.add_argument("-privacy_wording_file", action="store", dest="privacy_wording_file", required=True, help="path to privacy_wording file")    
...
def main():
    ...
    if start_mode == "master":
        ...
        droidbot = DroidBot(
            ...
            ignore_ad=opts.ignore_ad,
            replay_output=opts.replay_output,
            consent_condition=opts.consent_condition,
            privacy_wording_file=opts.privacy_wording_file)
        droidbot.start()
    return
